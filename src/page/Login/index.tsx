        ...
        <>
          ...
          >
            <ProFormText
              ...
              width="sm"
            />
            <img className='ant-form-item ant-form-item-control-input ant-input-affix-wrapper css-dev-only-do-not-override-bvtb8s ' src={picPath} alt="Captcha" onClick={fetchCaptchaImage}
              style={{
                maxWidth: "125px",
              }} />
          </div>
